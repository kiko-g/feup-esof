        ...
        child: Align(
          ...
          child: Row(
            ...
            Column(children: <Widget>[
                ...
                Text(" Francisco Gonçalves", style: TextStyle(fontSize: 16.0),),
                Image.network( 'https://avatars1.githubusercontent.com/u/40745490?s=460&v=4', width: 100, height: 100,),
                Padding(padding: EdgeInsets.all(10.0),),
                Text("João Mota", style: TextStyle(fontSize: 16.0),),
                ...
                Padding(padding: EdgeInsets.all(10.0),),
                Text("Luís Ramos", style: TextStyle(fontSize: 16.0),),
                ...
                Text("Return to Home Page", style: TextStyle(fontSize: 15.0, height: 0), textAlign: TextAlign.center,
              ),
             ],
            ),
